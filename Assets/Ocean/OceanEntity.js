...
import {OceanVertShader, OceanFragShader} from '/Barcelona/Assets/Ocean/OceanShader.js';
import { OceanParameters } from '/Barcelona/Assets/Ocean/OceanParams.js';
...
//   value: new THREE.Vector4(0.1, 0.15, 1.0, 1.0)
  ...
  constructor(scene){
    ...
    // let normalTexture = new THREE.TextureLoader().load('/Barcelona/Assets/Terrain/OceanNormal.png');
    // normalTexture.wrapS = normalTexture.wrapT = THREE.RepeatWrapping;

    // Create video texture
    // https://blenderartists.org/t/animated-water-normal-map-tileable-looped/673140
    // /Barcelona/lib/three.js/examples/?q=video#webgl_materials_video
    ...
    videoEl.src = '/Barcelona/Assets/Terrain/OceanNormal.mp4';
    videoEl.play();
    ...
    gltfLoader.load('/Barcelona/Assets/Terrain/OceanSurfaceLR.glb', (gltf) => {
      ...
      gltfLoader.load('/Barcelona/Assets/Terrain/OceanSurfaceMR.glb', (gltf) => {
        // Store the version
        ...
        // Load next resolution and add
        gltfLoader.load('/Barcelona/Assets/Terrain/OceanSurfaceHR.glb', (gltf) => {
