...
import { FlagBehavior } from '/Barcelona/Assets/Flag/FlagBehavior.js'
...
class FlagEntity {
  ...
  constructor(scene, onload){
    ...
    gltfLoader.load('/Barcelona/Assets/Flag/flag.glb', (gltf) => {
      // GLTF scene
  ...
  setFlagBeaufortColor(windInt){
    ...
    if (this.beaufortTextures[scale] == undefined){
      ...
      texture = loader.load('/Barcelona/Assets/Flag/BeaufortScale/'+ scale +'.png');
