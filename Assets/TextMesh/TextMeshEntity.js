// /Barcelona/lib/three.js/examples/#webgl_geometry_text
...
import { FontLoader } from '/Barcelona/lib/three.js/examples/jsm/loaders/FontLoader.js';
import { TextGeometry } from '/Barcelona/lib/three.js/examples/jsm/geometries/TextGeometry.js';
...
class TextMeshEntity {
  ...
  loadFont = function(callback){
    ...
    //fontLoader.load('/Barcelona/lib/three.js/examples/fonts/helvetiker_bold.typeface.json', (font) => {
    fontLoader.load('/Barcelona/Assets/TextMesh/Helvetica 65 Medium_Regular.json', (font) => { 
      this.font = font;
      callback();
    });
  }
